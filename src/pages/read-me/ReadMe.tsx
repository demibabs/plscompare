...
export function ReadMe() {
  return (
    <>
      <title>Read me! | plscompare</title>
      <main className="flex w-full flex-col items-center">
        <header className="bgp-zigZag-base-200/7 border-b-base-300 flex w-full flex-col items-center gap-3 p-10 text-center not-md:pb-15">
          <hgroup className="flex flex-col gap-3">
            <h1 className="text-main-text decoration-error text-3xl font-semibold underline md:text-4xl lg:text-5xl">
              Read me!
            </h1>
        ...
        <section className="-mt-5 grid w-full grid-cols-[1fr_clamp(0px,var(--container-xl),100%)_1fr] gap-y-10 p-10 not-md:pt-0 xl:lg:grid-cols-[minmax(0,1fr)_clamp(0px,var(--container-3xl),100%)_minmax(0,1fr)]">
          <ul className="col-span-1 col-start-2 flex w-full flex-col gap-3">
            ...
            <ReadMeCard
              ...
              content={
                <>Addressing some current issues with the site, and divulging some details about how it works.</>
              }
          ...
          <aside className="card col-span-1 my-auto max-h-fit w-full min-w-0 border-3 border-white/10 bg-white/10 not-lg:col-start-2 lg:col-start-3 lg:ml-10 lg:w-[calc(100%-2.5rem)]">
...
function ReadMeCard({ title, content, destination }: { title: ReactNode; content: ReactNode; destination: string }) {
  return (
    <li>
      <Link
        to={destination}
        className="card card-md md:card-lg bg-base-200 hover:bg-base-100 border-base-300 bgp-ticTacToe-base-300/10 w-full border-3"
      >
